...
public class CategoriaController {
	...
	public ResponseEntity<List<CategoriaModel>> getBycategoria(@PathVariable String acao){
		
		return ResponseEntity.ok(repository.findAllByAcaoContainingIgnoreCase(acao));
	}
